...
public class GraphicalInterface extends JPanel implements MouseListener, MouseMotionListener {
    ...
    public void makeEngineMove() {
        ...
        String move = Engine.pvs(Engine.maxDepth, Integer.MIN_VALUE / 2, Integer.MAX_VALUE / 2, "",
        ...
        if (Engine.counter < 300000 && Engine.maxDepth < 8 && Engine.ply > 30 && MoveGen.isEndGame) {
            Engine.maxDepth++;
            System.out.println(Engine.maxDepth);
        }
